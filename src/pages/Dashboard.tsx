  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm mb-8 transform hover:shadow-md transition-all duration-300">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card 
            className="cursor-pointer transition-all hover:shadow-md hover:scale-105 duration-300 border-2 border-transparent hover:border-blue-200" 
          ...
          >
            ...
            <CardContent>
              ...
              <Button 
                className="w-full mt-4 bg-blue-500 hover:bg-blue-600 transition-colors"
          ...
          <Card 
            className="cursor-pointer transition-all hover:shadow-md hover:scale-105 duration-300 border-2 border-transparent hover:border-red-200" 
          ...
          >
            ...
            <CardContent>
              ...
              <Button 
                className="w-full mt-4 bg-red-500 hover:bg-red-600 transition-colors"
          ...
          <Card 
            className="cursor-pointer transition-all hover:shadow-md hover:scale-105 duration-300 border-2 border-transparent hover:border-green-200" 
          ...
          >
            ...
            <CardContent>
              ...
              <Button 
                className="w-full mt-4 bg-green-500 hover:bg-green-600 transition-colors"
